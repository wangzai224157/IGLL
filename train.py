            ...
            if (i + 1) % config.viz_steps == 0:
                ...
                if config.pretrain_network is False:
                    print(
                        ...
                        'vgg_fm: %.2f, vgg_guided: %.2f ), D_loss: %.4f, LR : %f, svd: %.4f'
                        % (epoch + 1, i + 1, ret_loss['G_loss'], ret_loss['G_loss_vgg'], ret_loss['G_loss_ae'],
                           ...
                           ret_loss['G_loss_vgg_fm'], ret_loss['G_loss_vgg_guided'], ret_loss['D_loss'],ret_loss['svd'],ourModel.get_current_learning_rate()))
