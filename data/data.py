...
class InpaintingDataset(Dataset):
    def __init__(self, info_list, root_dir='', edge_dir='', im_size=(256, 256), transform=None):
    ...
    def __getitem__(self, idx):
        ...
        edge=self.read_image(os.path.join(self.edge_dir, self.filenames[idx]))
        sample = {'gt': image,'edge':edge}
