...
class TestOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--data_file', type=str, default='./imgs/celeba', help='the file storing testing file paths')
        self.parser.add_argument('--test_dir', type=str, default='./test_results', help='models are saved here')
        self.parser.add_argument('--edge_dir', type=str, default='', help='edge picture are given here')
        ...
        #self.parser.add_argument('--multi_gpu', type = bool, default = True, help = 'nn.Parallel needs or not')
        self.parser.add_argument('--gpu_ids', type=str, default='0')

        self.parser.add_argument('--random_mask',action='store_true',
        ...
        self.parser.add_argument('--dataset_path', type=str, default='celeba_data',help='wangzai  addition.')
